...
extern void keep_char(uint8_t c);
extern GPIO_TypeDef * digport[];
extern uint16_t digpin[];
extern uint8_t codes[];
extern GPIO_TypeDef * segport[];
extern uint16_t segpin[];
extern uint8_t expression[100];
extern uint8_t end;
extern GPIO_TypeDef * rowsport[];
extern uint16_t rows[];
extern uint8_t keyboard[6][3];
extern uint8_t flag;
extern void close(void);
extern int flag2;
int counter_ms, counter_4ms = 0;
/* USER CODE END TD */
